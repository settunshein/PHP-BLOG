...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <form action="<?= $_SERVER['PHP_SELF']; ?>" method="POST" id="createCategoryForm"> 
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input name="logo" id="logo" type="text" class="form-control form-control-sm">
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="description" id="desc" cols="30" rows="5" class="form-control form-control-sm"></textarea>
                            </div>
                        </div>
                    </div>
