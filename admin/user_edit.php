...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <form action="<?= $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data" id="editUserForm"> 
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="password" id="password" type="password" class="form-control form-control-sm" readonly placeholder="* * * * * * * *">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="custom-select custom-select-sm" id="role" name="role">
                                            <option disabled class="text-muted">Select User Role</option>
