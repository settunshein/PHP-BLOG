...
if( isset($_GET['edit_profile_id']) ){
    $id   = $_GET['edit_profile_id'];
    $user = get_user($id);
}
...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <form action="<?= $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data" id="editProfileForm"> 
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="card-custom-title">Edit Profile Form</span>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="password" type="password" class="form-control form-control-sm" readonly placeholder="* * * * * * * *">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="password" type="text" class="form-control form-control-sm" readonly value="<?= ucwords(strtolower($user->role)) ?>">
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            data-default-file="<?= isset($user->image) ? 'uploads/user/'.$user->image : '' ?>">
                                        </div>
                                    </div>
                                </div><!-- End of card-body -->

                                <div class="card-footer">
                                    <button class="btn btn-sm btn-outline-dark rounded-0 float-right" type="submit" name="edit_profile">
