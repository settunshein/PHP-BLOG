...
$posts      = get_category_posts($_GET['category']);
?>
                        ...
                        <div class="blog1-post-holder">
                            ...
                            <div class="text-box-inner post-txt-blk">
                                ...
                                <div class="blog-post-info"> 
                                    ...
                                    <span class="custom-mr-10"><i class="ri ri-question-answer-line"></i> 15 Comments</span> 
                                    <span><i class="ri ri-question-answer-line"></i> 15 Comments</span> 
                                </div>
                                <br>
